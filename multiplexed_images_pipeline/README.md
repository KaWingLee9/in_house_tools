...
While SOAPy used z-score as the statistic to reflect the proximity between two cell types, here we used the P value against the null hypothesis generated by permutation as statistic. The codes are simply modified from SOAPy, and the parameters are totally same as `sp.tl.neighborhood_analysis`.  
